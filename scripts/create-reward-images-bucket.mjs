/**
 * Supabase Storage에 리워드 이미지 업로드용 "reward-images" 버킷을 생성한다.
 * 이미 있으면 조용히 건너뛴다(멱등). 자세한 설계 배경은
 * docs/migrations/040_reward_images_storage_bucket.sql 참고.
 *
 * 사용법: node scripts/create-reward-images-bucket.mjs
 */
