  ...
  return (
    <div className="absolute inset-0 bg-black/85 z-50 flex flex-col">
      ...
      <div className="flex justify-center pb-12">
        <button
          onClick={onSkip}
          className="bg-orange-500 hover:bg-orange-400 active:bg-orange-600 text-white font-bold text-lg px-12 py-4 rounded-full shadow-lg transition-colors"
        >
          스타트
        </button>
      </div>
